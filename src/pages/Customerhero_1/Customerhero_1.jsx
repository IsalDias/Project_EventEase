  ...
  return (
    <div>
      <div className='cust_hero_first' style={{ backgroundImage: `url(${Customer_hero1})` }}>
        ...
        <Button variant="contained" href='/services' className='services_button_left' style={{ backgroundColor:"#FF0054", fontSize: "100%"}}>
          Services
        </Button>


        <Button variant="contained" href='/events' className='services_button_right' style={{ backgroundColor:"#FF0054", fontSize: "100%"}}>
          Events
        </Button>
        ...
        <p className='other_text_bottom'>
          <em className='creating'>CREATING</em> your dream event,<br />
